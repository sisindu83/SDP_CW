 ...
 <div class="sidebar-wrapper sidebar-theme">
     ...
     <nav id="sidebar">
         ...
         <div class="navbar-nav theme-brand flex-row  text-center">
             <div class="nav-logo">
                 <div class="nav-item theme-logo">
                     <a href="#">
                         <img src="<?php echo url('/'); ?>/assets/src/assets/img/logo.svg" class="navbar-logo" alt="logo">
                     </a>
                 </div>
         ...
         <ul class="list-unstyled menu-categories" id="accordionExample">
             ...
             <li class="menu">
                 <a href="{{ route('user.register.home') }}" aria-expanded="false" class="dropdown-toggle">
                     <div class="">
                         ...
                         <svg fill="#ffffff" height="200px" width="200px" version="1.1" id="Layer_1"
                             ...
                             <g id="SVGRepo_iconCarrier">
                                 ...
                                 <g>
                                     <g>
                                         <path
                                             d="M503.83,392.17H8.17c-4.512,0-8.17,3.657-8.17,8.17V503.83c0,4.513,3.658,8.17,8.17,8.17h495.66 c4.512,0,8.17-3.657,8.17-8.17V400.34C512,395.827,508.342,392.17,503.83,392.17z M495.66,495.66H16.34v-87.149H495.66V495.66z">
                                         </path>
                                     </g>
                                 </g>
                                 <g>
                                     <g>
                                         <path
                                             d="M256,0c-51.057,0-92.596,41.538-92.596,92.596s41.538,92.596,92.596,92.596s92.596-41.538,92.596-92.596S307.057,0,256,0z M256,168.851c-42.047,0-76.255-34.208-76.255-76.255S213.953,16.34,256,16.34s76.255,34.208,76.255,76.255 S298.047,168.851,256,168.851z">
                                         </path>
                                     </g>
                                 </g>
                                 <g>
             ...
             <li class="menu">
                 <a href="pwrestpswreset" aria-expanded="false" class="dropdown-toggle">
                     <div class="">
                         <svg fill="#ffffff" height="165px" width="165px" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.00 512.00"
                             xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512"
                             stroke="#ffffff" stroke-width="16.896">
                             <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                             <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                             <g id="SVGRepo_iconCarrier">
                                 <g>
                                     <g>
                                         <path
                                             d="M422.2,11H89.8C46.4,11,11,46.4,11,89.8v91.8c0,27.1,14.1,52.1,36.4,66.4c-2.7,9.5-4.2,19.4-4.2,29.6 c0,1.7-29.4-7.5-32.2,20.4v182.6c0,11.3,9.1,20.4,20.4,20.4h248.6c11.3,0,20.4-9.1,20.4-20.4V298c-2.6-27.4-32.2-19-32.2-20.4 c0-5.8-0.5-11.6-1.4-17.2h155.4c43.4,0,78.8-35.4,78.8-78.8V89.8C501,46.4,465.6,11,422.2,11z M259.6,460.2H51.8V318.4h207.8 V460.2z M84.1,277.6c1.1-38.7,32.8-69.8,71.7-69.8c38.9,0,70.6,31.1,71.7,69.8H84.1z M460.2,181.6c0,20.9-17,38-38,38H251 C231,188.3,195.5,167,155.7,167c-36.2,0-68.9,17.5-89.6,44.3c-8.8-7.1-14.3-18-14.3-29.7V89.8c0-20.9,17-38,38-38h332.4 c20.9,0,38,17,38,38V181.6z">
                                         </path>
                                         <path
                                             d="m116.9,115.3h-7c-11.3,0-20.4,9.1-20.4,20.4s9.1,20.4 20.4,20.4h7c11.3,0 20.4-9.1 20.4-20.4s-9.1-20.4-20.4-20.4z">
                                         </path>
                                         <path
                                             d="m212,115.3h-7c-11.3,0-20.4,9.1-20.4,20.4s9.1,20.4 20.4,20.4h7c11.3,0 20.4-9.1 20.4-20.4s-9.1-20.4-20.4-20.4z">
                                         </path>
                                         <path
                                             d="m307,115.3h-7c-11.3,0-20.4,9.1-20.4,20.4s9.1,20.4 20.4,20.4h7c11.3,0 20.4-9.1 20.4-20.4s-9.1-20.4-20.4-20.4z">
                                         </path>
                                         <path
                                             d="m402.1,115.3h-7c-11.3,0-20.4,9.1-20.4,20.4s9.1,20.4 20.4,20.4h7c11.3,0 20.4-9.1 20.4-20.4s-9.1-20.4-20.4-20.4z">
                                         </path>
                                     </g>
                                 </g>
                             </g>
