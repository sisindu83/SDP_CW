...
<input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" class="form-control mb-3" id="contactno" placeholder="Contact No" >
</div>
</div>
<div class="col-md-4">
<div class="form-group">
...
<input type="email" id="email" name="email" class="form-control mb-3" id="gn" placeholder="GN Division">
</div>
</div> 
...
<button class="btn btn-secondary">Regitser</button>
</div>
</div>
</div>
</form>
